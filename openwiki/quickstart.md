...
- Supports multiple model providers — OpenAI (default, API key or ChatGPT OAuth login), OpenRouter, Anthropic, Z.AI, Baseten, Fireworks, NVIDIA NIM, and any OpenAI-compatible gateway — each with their own API key and model list.
