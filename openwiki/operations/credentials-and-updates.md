...
- Provider API keys: `OPENROUTER_API_KEY`, `OPENAI_API_KEY`, `OPENAI_COMPATIBLE_API_KEY`, `ANTHROPIC_API_KEY`, `ZAI_API_KEY`, `BASETEN_API_KEY`, `FIREWORKS_API_KEY`, `NVIDIA_API_KEY`
...
2. Otherwise, use the first available provider API key in this order: Z.AI, OpenAI, OpenAI-compatible, OpenRouter, Anthropic, Baseten, Fireworks, then NVIDIA NIM.
